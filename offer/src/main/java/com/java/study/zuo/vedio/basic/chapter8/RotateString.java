...
//    private static void rotate2(char[] chas, int size) {
...
//    }
    ...
    private static void exchange(char[] chas, int start, int end, int size) {
//        int i = end - size + 1;
//        char temp = 0;
//        while (size-- != 0) {
//            temp = chas[start];
...
//        }
    ...
    private static void rotate1(char[] chas, int size) {
