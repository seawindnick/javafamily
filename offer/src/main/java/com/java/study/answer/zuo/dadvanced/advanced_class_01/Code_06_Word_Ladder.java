package com.java.study.answer.zuo.dadvanced.advanced_class_01;
...
public class Code_06_Word_Ladder {
    ...
    public static List<List<String>> findLadders(String beginWord,
        ...
        System.out.println(JSONObject.toJSONString(nexts));
        HashMap<String, Integer> distances = getDistances(beginWord, nexts);
        System.out.println(JSONObject.toJSONString(distances));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(JSONArray.toJSONString(findLadders(beginWord, endWord, new ArrayList<>(Arrays.asList(wordList)))));
    }
